...
//        h_p(2) = xhat_p(2);
//        h_p(3) = xhat_p(3);
//        h_p(4) = Vahat*cosf(xhat_p(6)) + xhat_p(4) - xhat_p(2)*cosf(xhat_p(3));  // pseudo measurement
//        h_p(5) = Vahat*sinf(xhat_p(6)) + xhat_p(5) - xhat_p(2)*sinf(xhat_p(3));
//        //h_p(6) = 1;
//        math::Matrix<7,7> I_p;
//        I_p.identity();
////        math::Matrix<7,7> C_p;
...
//        C_p(4,3) = xhat_p(2)*sinf(xhat_p(3));
//        C_p(4,6) = -Vahat*sinf(xhat_p(6));
//        C_p(5,2) = -sin(xhat_p(3));
//        C_p(5,3) = -xhat_p(2)*cosf(xhat_p(3));
//        C_p(5,6) = Vahat*cosf(xhat_p(6));
//        C_p(6,6) = 0.05;
////        math::Matrix<7,7> L_p;
